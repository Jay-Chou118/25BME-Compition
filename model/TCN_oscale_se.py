...
class TemporalBlock(nn.Module):
    def __init__(self, ni, nf, ks_list, stride, dilation, padding, dropout=0.):
        ...
        self.se1 = SEAttention1d(nf*len(ks_list),reduction=10)
        self.relu1 = nn.ReLU()
    ...
    def forward(self, x):
        ...
        out = self.dropout1(self.relu1(self.se1(torch.cat(tuple(conv_result_list1), 1))))
...
class TCN(nn.Module):
    def __init__(self, c_in, c_out, layers=8*[30], ks=7, conv_dropout=0., fc_dropout=0.):
